            ...
            <div className="border-t border-zinc-900 p-4 space-y-3 bg-[#0c0c0d]">
                {!isCollapsed && (
                    <div className="flex items-center gap-3 px-2 py-1">
                        <div className="h-9 w-9 rounded-full bg-amber-500 text-black flex items-center justify-center font-bold shrink-0">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <p className="text-xs text-zinc-500 font-medium truncate">{user?.role || 'Administrator'}</p>
                        </div>
                    </div>
                )}
                <Button
